...
def em_param2(x,y,T,Q):#x:cqt(512,32) y:mgd(512,32) T:(512,512) Q:(512,512)
    ...
    E1=torch.mm(T,x)
    E2=torch.mm(Q,y)
    E3=torch.cat((E1,E2),0)
    E11=E1@torch.transpose(E1,dim0=0,dim1=1)
    E22=E2@torch.transpose(E2,dim0=0,dim1=1)
    E33=E3@torch.transpose(E3,dim0=0,dim1=1)
